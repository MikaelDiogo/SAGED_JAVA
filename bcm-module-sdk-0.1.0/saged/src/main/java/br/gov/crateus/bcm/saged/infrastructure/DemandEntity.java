...
public class DemandEntity extends SdkAuditableEntity {
    ...
    public String getCurrentTechnicalNote() {
        return currentTechnicalNote;
    }

    public void setCurrentTechnicalNote(String currentTechnicalNote) {
        this.currentTechnicalNote = currentTechnicalNote;
    }
