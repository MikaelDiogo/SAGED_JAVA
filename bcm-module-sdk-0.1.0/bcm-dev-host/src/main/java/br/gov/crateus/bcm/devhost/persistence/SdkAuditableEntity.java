package br.gov.crateus.bcm.devhost.persistence;
...
/**
 * Same audit columns as BCM {@code BaseAuditableEntity}. Modules in the Dev Host
 * should extend this class (or mirror the columns in their JPA entities).
 */
@MappedSuperclass
